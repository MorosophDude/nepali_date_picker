...
Future<NepaliDateTime?> showNepaliMonthPicker({
  ...
  Widget picker = MonthPicker(
    firstDate: NepaliDateTime(now.year, firstMonth),
    lastDate: NepaliDateTime(now.year, lastMonth),
    currentDate: currentMonth != null
        ? NepaliDateTime(now.year, currentMonth)
        : NepaliDateTime.now(),
    selectedDate: selectedMonth == null
        ? null
        : NepaliDateTime(now.year, selectedMonth),
    onChanged: (value) => Navigator.pop(context, value),
    calendarDelegate: NepaliCalendarDelegate(),
  );
